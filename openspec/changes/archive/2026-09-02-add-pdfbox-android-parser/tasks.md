...
- [x] 5.4 Update `DEPLOYMENT.md` with PdfBox dependency, qualification, verification, and rollback steps and update `AGENT_README.md` with the selected parser and current gate evidence, and verify both documents match the checked-in release evidence.
