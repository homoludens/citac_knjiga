...
- [x] 5.3 Update `DEPLOYMENT.md` and `AGENT_README.md` with direct-download configuration, pinned release hashes, network policy, deletion/regeneration behavior, progress semantics, rollback, and verification commands.
